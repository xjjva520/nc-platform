...
public class DigestUtil extends DigestUtils{
    ...
    public static String sha224Hex(String data) {
        return sha224Hex(data.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public static String sha384Hex(String data) {
        return sha384Hex(data.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public static String digestHex(String algorithm, byte[] bytes) {
        try {
            ...
            throw ExceptionsUtil.unchecked(var3);
        }
    }

    public static String hmacMd5Hex(String data, String key) {
        return hmacMd5Hex(data.getBytes(StandardCharsets.UTF_8), key);
    }
    ...
    public static String hmacSha1Hex(String data, String key) {
        return hmacSha1Hex(data.getBytes(StandardCharsets.UTF_8), key);
    }
    ...
    public static String hmacSha224Hex(String data, String key) {
        return hmacSha224Hex(data.getBytes(StandardCharsets.UTF_8), key);
    }
    ...
    public static byte[] hmacSha256(String data, String key) {
        return hmacSha256(data.getBytes(StandardCharsets.UTF_8), key);
    }
    ...
    public static String hmacSha256Hex(String data, String key) {
        return hmacSha256Hex(data.getBytes(StandardCharsets.UTF_8), key);
    }
    ...
    public static String hmacSha384Hex(String data, String key) {
        return hmacSha384Hex(data.getBytes(StandardCharsets.UTF_8), key);
    }
    ...
    public static String hmacSha512Hex(String data, String key) {
        return hmacSha512Hex(data.getBytes(StandardCharsets.UTF_8), key);
    }
    ...
    public static String digestHMacHex(String algorithm, final byte[] bytes, String key) {
        ...
        try {
            ...
            throw ExceptionsUtil.unchecked(var5);
        }
    }
    ...
    public static boolean slowEquals(@Nullable String a, @Nullable String b) {
        return (a != null && b != null) && slowEquals(a.getBytes(StandardCharsets.UTF_8), b.getBytes(StandardCharsets.UTF_8));
    }
